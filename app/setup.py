...
# Read meta-data
about = {}
exec(open('ansutr/transliteration/__metadata.py').read(), about)

# This call to setup() does all the work
setup(
    name="ansu-transliteration",
    ...
    url="https://github.com/ansunlp/transliterator",
    project_urls={
    ...
    author="Sanjana",
    author_email="ansunlp123@gmail.com",
    packages=["ansutr.transliteration"],
    packages=find_packages(exclude=("tests",)),
    packages=find_packages(include=('ansutr.transliteration*')),
